...
internal static partial class ResultHelper
{
    ...
    internal sealed partial class ExecuteCommand : InvokableCommand
    {
        private readonly Action _action;
        private readonly string _confirmationMessage;
        private readonly bool _confirm;

        public ExecuteCommand(bool confirm, string confirmationMessage, Action action)
        {
            Name = Resources.Microsoft_plugin_sys_confirmation;
