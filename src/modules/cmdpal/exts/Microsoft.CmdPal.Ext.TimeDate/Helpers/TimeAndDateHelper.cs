...
internal static class TimeAndDateHelper
{
    ...
    internal static bool IsSpecialInputParsing(string input) => Regex.IsMatch(input, @"^.*(u|ums|ft)\d");
    ...
    internal static CalendarWeekRule GetCalendarWeekRule(string pluginSetting) => int.TryParse(
        pluginSetting,
        out var result) ? GetCalendarWeekRule(result) : DateTimeFormatInfo.CurrentInfo.CalendarWeekRule;
    ...
    internal static DayOfWeek GetFirstDayOfWeek(string pluginSetting) => int.TryParse(
        pluginSetting,
        out var result) ? GetFirstDayOfWeek(result) : DateTimeFormatInfo.CurrentInfo.FirstDayOfWeek;
}
