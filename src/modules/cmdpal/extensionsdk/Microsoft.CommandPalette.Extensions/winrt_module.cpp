//TYPICALLY: This file is generated by C++/WinRT (this one was originally fron
...
//runtimeclasses in it. But we need something to appease WinRT, so this is the
//empty version of this file, without any classes in it.
//
