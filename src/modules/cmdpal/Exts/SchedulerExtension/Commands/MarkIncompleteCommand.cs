...
internal sealed partial class MarkIncompleteCommand : InvokableCommand
{
    private readonly ToDoItem _todoItem;
    private readonly SchedulerExtensionPage _page;

    internal MarkIncompleteCommand(ToDoItem todoItem, SchedulerExtensionPage page)
    {
        this._todoItem = todoItem;
        this._page = page;
        this.Name = "Mark as Not Started";
        this.Icon = new("\uE8A7");
    }
    ...
    private async Task<CommandResult> InvokeAsync()
    {
        try
        {
            ...
            var updateData = new
            {
                status = "notStarted", // If you're marking as complete
            };
