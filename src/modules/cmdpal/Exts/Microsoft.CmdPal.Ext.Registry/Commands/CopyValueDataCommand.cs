...
internal sealed partial class CopyValueDataCommand : InvokableCommand
{
    private readonly RegistryEntry _entry;

    internal CopyValueDataCommand(RegistryEntry entry)
    {
    ...
    {
        TryToCopyToClipBoard(_entry.GetValueData());
